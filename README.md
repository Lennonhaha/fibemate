...
- **TLS 1.3 X25519MLKEM768** — nginx + OpenSSL 3.0.13 + oqs-provider，原生混合后量子握手，KeyShare 1222B
...
| **TLS 1.3 混合** | X25519MLKEM768 + SM2+ML-KEM 双轨道 | 全链路验证 |
...
- **TLS 层** (路径 A): X25519MLKEM768 — nginx 原生混合握手，lg-052 存证
