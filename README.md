...
**v3.2-preview** | 2026-07-07  
TSR 序列: lg-001 ~ lg-057 | 许可证: GNU GPLv3  
...
- **TLS 1.3 混合后量子握手** — 路径 A (X25519MLKEM768, NamedGroup) 已于 2026-07-07 搁置（浏览器/nginx 技术阻断） · 路径 C-2 (SM2+ML-KEM-768) 应用层 ✅ 5/5, p95=78.5ms, lg-053/lg-057
...
| **FPGA v5** | NTT 流水线 + LFSR PRNG + 故障保护 | Artix-7 合成通过 · 物理验证 uart_tx=3.26V ✅ |
