...
/**
 * ML-KEM-768 ‚Ä?Constant-time hardened reference implementation
 *
...
// ============================================================================
// Modular arithmetic (WARNING: not truly constant-time in pure JS ‚Ä?JIT may reorder.
// This file is for auditability; use the WASM path for production workloads.)
// ============================================================================
/**
 * Modular addition in Z_Q. Returns (a+b) mod 3329.
 * WARNING: ternary-based ‚Ä?not truly CT in pure JS.
 * @param {number} a
 * @param {number} b
...
// ============================================================================
// Polynomial multiplication ‚Ä?Constant-time negacyclic convolution
...
// ============================================================================
/**
 * Polynomial multiplication in Z_Q[x]/(x^256+1) ‚Ä?negacyclic convolution.
 * Constant-time: no coefficient skips, no early exits. ~65536 modMul ops.
 * @param {Int16Array} f ‚Ä?256 coefficients
 * @param {Int16Array} g ‚Ä?256 coefficients
...
// ============================================================================
// Matrix/Vector operations ‚Ä?ALL in time domain
// ============================================================================

/**
 * Matrix-vector multiplication over R_q = Z_Q[x]/(x^256+1).
 * r[i] = sum_{j=0}^{k-1} A[i][j] * s[j]
 * @param {Int16Array[][]} A ‚Ä?k√ók polynomial matrix
 * @param {Int16Array[]} s ‚Ä?k-vector of polynomials
 * @param {number} k ‚Ä?dimension (3 for ML-KEM-768)
 ...
 * d=12 ‚Ü?384 bytes; d=4 ‚Ü?128 bytes; d=10 ‚Ü?320 bytes.
 * @param {Int16Array} f ‚Ä?256 coefficients in Z_Q
 * @param {number} d ‚Ä?bits per coefficient
 ...
 * @param {Uint8Array} data ‚Ä?serialized bytes
 * @param {number} d ‚Ä?bits per coefficient
 ...
 * @param {Int16Array} f ‚Ä?256 coefficients in Z_Q
 * @param {number} d ‚Ä?target bits (10 for u, 4 for v)
 ...
 * x = round((Q / 2^d) * c)
 * @param {Int16Array} g ‚Ä?d-bit coefficients
 * @param {number} d ‚Ä?bits (10 or 4)
...
/**
 * Centered Binomial Distribution with Œ∑=2.
 * Samples 256 coefficients from 128 bytes of input.
 * Each coefficient = HW‚Ç?even nibble) - HW‚Ç?odd nibble).
 * @param {Uint8Array} buf ‚Ä?128 bytes of random input
 ...
 * @param {Uint8Array} seed ‚Ä?32-byte domain separator (œÅ or œÉ)
 * @param {number} nonce ‚Ä?row/col index for matrix position
...
// ============================================================================
// KeyGen, Encaps, Decaps ‚Ä?Pure Time Domain
// ============================================================================
 ...
 *
 * @param {Uint8Array} publicKey ‚Ä?1184 bytes
...
/**
 * ML-KEM-768 decapsulation ‚Ä?constant-time hardened.
 *
 * @param {Uint8Array} secretKey ‚Ä?2400 bytes
 * @param {Uint8Array} ciphertext ‚Ä?1088 bytes
 * @returns {Uint8Array} sharedSecret ‚Ä?32 bytes
 */
